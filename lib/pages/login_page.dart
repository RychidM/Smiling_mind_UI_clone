...
import 'package:smilling_mind/pages/welcome_screen.dart';
            ...
            Padding(
              ...
              child: Align(
                child: Column(
                  ...
                  children: [
                    Image(
                      image: AssetImage("imgs/Work-and-life.png"),
                      height: 200,
                      width: 300,
                    ),
                    SizedBox(height: 65),
                        ...
                        child: Row(
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 20.0),
                              child: Image(
                                image: AssetImage("imgs/google.png"),
                                height: 28,
                                width: 28,
                              ),
                            ),
                    ...
                    Center(
                      child: GestureDetector(
                        ...
                        child: LargeText(
                          text: "New to Smiling Mind? Register",
                          size: 13,
                          color: AppColor.bgSeat,
                        ),
                      ),
